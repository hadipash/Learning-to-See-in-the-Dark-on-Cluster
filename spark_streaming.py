...
conf.set('spark.yarn.dist.files',
         'file:/usr/local/lib/python2.7/dist-packages/pyspark/python/lib/pyspark.zip,'
         'file:/usr/local/lib/python2.7/dist-packages/pyspark/python/lib/py4j-0.10.7-src.zip')
...
cluster = TFCluster.run(sc, inference_Sony.main_fun, args, args.cluster_size, num_ps, args.tensorboard,
                        TFCluster.InputMode.SPARK)

labelRDD = cluster.inference(imageRDD)
# TODO: send back to back-end
